			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center animate-box intro-heading">
						<span class="icon"><i class="flaticon-cutlery"></i></span>
						<h2>Azure Menu</h2>
						<p>All dishes are made with absolute perfection and lots of love. Your tastebuds are inbound for a delicious ride.</p>
					</div>
				</div>
				<div class="row">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<ul class="nav nav-tabs text-center" role="tablist">
									<li role="presentation" class="active"><a href="#pakistani" aria-controls="mains"
											role="tab" data-toggle="tab">Pakistani</a></li>
									...
									<div class="col-md-12">
                                     ...
                                     while($row = mysqli_fetch_assoc($pakistani))
										...
										?> 
											...
											<div class="dish-img"
														style="background-image: url(<?php echo $row['Img']; ?>);"></div>
												</figure>
												...
												<div class="text">
												 ...
												 <a class="button" href="javascript:pak(<?php echo $row['PRICE'];?>)"><i class="fas fa-shopping-cart fa-3x" ></i></a>
                                               </span>
										   ...
										   ?> 
											...
											<div class="dish-img"
												...
												<div class="text">
													...
													<span class="priceButton flex-nowrap" >
												 <a class="button" href="javascript:ital(<?php echo $row['PRICE'];?>)"><i class="fas fa-shopping-cart fa-3x" ></i></a>
                                               </span>
										   ...
										   ?> 
											...
											<div class="dish-img"
												...
												<div class="text">
													...
													<input type="text" name="pds" value="<?php echo $row['PRICE'] ?>" style="display:none" name="dq">
                                                 
													</span>
                                                 
												<span class="priceButton flex-nowrap" >
												 <a class="button" href="javascript:desert(<?php echo $row['PRICE'];?>)"><i class="fas fa-shopping-cart fa-3x" ></i></a>
                                               </span>
										   ...
										   ?> 
											...
											<div class="dish-img"
												...
												<div class="text">
													...
													<span class="priceButton flex-nowrap" >
												 <a class="button" href="javascript:drink(<?php echo $row['PRICE'];?>)"><i class="fas fa-shopping-cart fa-3x" ></i></a>
                                               </span>
					...
					<div class="col-md-12 animate-box text-center">
						...
						<p><button class="btn btn-primary btn-outline btn-md" onclick="order()" >Pre-Order for Reservation</button></p>
					
							<p><button class="btn btn-primary btn-outline btn-md" onclick="order2()" >Order for Delivery</button></p>
						
							<p><button class="btn btn-primary btn-outline btn-md"><a href="cart.php">Go to Cart</a>
							</button></p>
...
?>
<input type="text"  value ="<?php echo $_GET['cid'] ?>" style="display:none" name="cid" id="iid" style="display:none;">
...
<footer>
  ...
  <script language="javascript">
    ...
    // })
	  ...
	  console.log(cid);
	  link = 'http://localhost:8012/Ayesha/menuPHP.php?pq='+pquan+'&pp='+pp+'&iq='+iquan+'&ip='+pi+'&dsq='+dsquan+'&dsp='+pds+'&drq='+drquan+'&drp='+pdr+'&id='+cid;
	  console.log(link);
	  $.get(link,function (data) { 
            console.log(data);
        
        });
	alert("Ordered for reservation");
	window.location.href = "http://localhost:8012/Ayesha/checkout.php";

		}
	// <?php
	// window.location.href = "http://localhost:8012/Ayesha/cart.html";
	// ?>
	  }
	  ...
	  // var cid=document.getElementById("iid").value;  
	  // console.log(cid);
	  // link = 'http://localhost/Ayesha/menuPHP.php?pq='+pquan+'&pp='+pp+'&iq='+iquan+'&ip='+pi+'&dsq='+dsquan+'&dsp='+pds+'&drq='+drquan+'&drp='+pdr+'&id='+cid;
	  // console.log(link);
	  // $.get(link,function (data) { 
   //          console.log(data);
