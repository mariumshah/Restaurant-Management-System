			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center animate-box intro-heading">
						...
						<p>Book a table prior to the day you want to come to Azure to avoid any hassle.</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="row">
							<div class="col-md-12">
								<form class="colorlib-form" action="reservation_check.php" method="post">
				              	<div class="row">
										...
										<div class="col-md-6 animate-box">
											<div class="form-group">
												...
												<div class="form-field">
													...
													<input type="date" name="rdate" placeholder="date" class="form-control">
												</div>
											</div>
										</div>
										<div class="col-md-6 animate-box">
											<div class="form-group">
												...
												<div class="form-field">
													...
													<select name="rtime" id="time" class="form-control">
										...
										<div class="col-md-6 animate-box">
											<div class="form-group">
												...
												<div class="form-field">
													<i class="icon icon-arrow-down3"></i>
													<select name="people" id="people" placeholder="person" class="form-control">
