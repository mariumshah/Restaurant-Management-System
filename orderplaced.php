...
.iconFeature span::before
{
  ...
  background-color: #303030;
    ...
    <section class="ftco-section ftco-cart">
			<div class="container">
				<div class="row">
    			<p style="text-align:center; font-size: 40px;"><strong>Thankyou for placing your order with Azure!</strong></p>
    		</div>
    		<br>
    		<br>
    		<div class="row justify-content-center">
    			<div class="col col-lg-12 col-md-1 cart-wrap ftco-animate">
    				<p class="text-center"><a href="index.php" class="btn btn-primary py-3 px-4">Back to Home</a></p>
    			</div>
    		</div>
			</div>
		</section>
