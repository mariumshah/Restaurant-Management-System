	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/bg1.jpg);" data-stellar-background-ratio="0.5">
						...
						<div class="row">
							<div class="col-md-4 animate-box">
								...
								<ul class="contact-info">
									<li><span><i class="icon-map5"></i></span>68-D Khayaban-e-Shahbaz, D.H.A Phase 6 Commercial Area Phase 6 Defence Housing Authority, Karachi City, Sindh 75500/li>
									<li><span><i class="icon-phone4"></i></span>(021) 35243124</li>
									<li><span><i class="icon-envelope2"></i></span><a href="#">info@azure.com</a></li>
									<li><span><i class="icon-globe3"></i></span><a href="#">www.azure.com</a></li>
								</ul>
							</div>
