...
<section class="ftco-section">
    ...
    <form action="#" class="billing-form">
              ...
              <div class="row align-items-end">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="House number, street name and area">
                  </div>
                </div>
                <div class="w-100"></div>
                <div class="w-100"></div>
            ...
            <div class="row mt-5 pt-3 d-flex">
              <div class="col-md-6 d-flex">
                <div class="cart-detail cart-total bg-light p-3 p-md-4">
                  ...
                  <p class="d-flex">
                    <span>Tuna Roast</span>
                    <span>100</span>
                  </p>
                  <p class="d-flex">
                    <span>Special Cake</span>
                    <span>270</span>
                  </p>
                  <p class="d-flex">
              ...
              <div class="col-md-6">
                <div class="cart-detail bg-light p-3 p-md-4">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <div class="radio">
                         <label><input type="radio" name="optradio" class="mr-2"> Cash on Dellivery</label>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
          ...
          <div class="col col-lg-12 col-md-1 cart-wrap ftco-animate">
            <p class="text-center"><a href="orderplaced.php" class="btn btn-primary py-3 px-4">Place your Order</a></p>
          </div>
        </div>
          </div> <!-- .col-md-8 -->
        </div>
